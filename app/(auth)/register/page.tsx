...
export default function RegisterPage() {
  ...
  return (
    <AuthShell mode="register">
      <div className="bl-auth-heading"><p>Daftar mitra BioLoop</p><h2>Mulai dari peran Anda.</h2><span>Setelah terdaftar, Anda akan langsung diarahkan ke dashboard yang sesuai.</span></div>
      ...
      <form className="bl-auth-form" onSubmit={handleSubmit}>
        ...
        <label><span>Peran Anda</span><div><Building2 size={17} aria-hidden="true" /><select value={role} onChange={(event) => setRole(event.target.value as UserRole)}><option value="producer">Usaha makanan / penghasil sisa organik</option><option value="recycler">Pengolah Black Soldier Fly</option><option value="driver">Mitra logistik</option></select></div></label>
